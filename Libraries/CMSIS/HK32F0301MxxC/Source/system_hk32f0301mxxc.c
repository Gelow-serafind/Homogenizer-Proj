...
* @filename:  system_hk32f0301mxxc.c
* @brief:     CMSIS Cortex-M0 Device Peripheral Access Layer System Source File.
*             This file contains the system clock configuration for HK32f0301mxxc devices,
*             and is generated by the clock configuration tool
*             1.  This file provides two functions and one global variable to be called from
*             user application:
*             - SystemInit(): Setups the system clock (System clock source, AHB/APBx prescalers and Flash settings).
*             This function is called at startup just after reset and
*             before branch to main program. This call is made inside
*             the "startup_hk32f0301mxxc.s" file.
...
*             Then SystemInit() function is called, in "startup_hk32f0301mxxc.s" file, to
...
/** @addtogroup HK32F0301MxxC_system
  * @{
  */

/** @addtogroup HK32F0301MxxC_System_Private_Includes
  * @{
  */
...
/** @addtogroup HK32F0301MxxC_System_Private_FunctionPrototypes
  * @{
  */
...
/** @addtogroup HK32F0301MxxC_System_Private_Functions
  * @{
  */
/**
...
/**
  * @brief  load the system hsi optionbytes .
  *         load  the system optionbytes to registers ,NO CHANGE!NO CHANGE!NO CHANGE!.
  * @param  None
  * @retval None
  */
...
/**
  * @brief  load the system pmu optionbytes .
  *         load  system optionbytes to registers ,NO CHANGE!NO CHANGE!NO CHANGE!.
  * @param  None
  * @retval None
  */
...
static void SetSysClockToHSI(void)
{
	...
	if (HSIStatus == (uint32_t)0x01)
	{
		...
		/* PCLK = HCLK */
		RCC->CFGR = (uint32_t)(RCC_HCLK_Div1|RCCPCLKReg);

		/* Select HSI as system clock source */
        RCCSYSCLKReg = RCC->CFGR;
		RCCSYSCLKReg &= (uint32_t)((uint32_t)~(RCC_CFGR_SW_Mask));
		RCC->CFGR |= (uint32_t)(RCC_SYSCLKSource_HSI|RCCSYSCLKReg);    
...
static void SetSysClockToLSI(void)
{
	...
	if (LSIStatus == (uint32_t)0x01)
	{
        ...
        RCCSYSCLKReg = RCC->CFGR;
		RCCSYSCLKReg &= (uint32_t)((uint32_t)~(RCC_CFGR_SW_Mask));
		RCC->CFGR |= (uint32_t)(RCC_SYSCLKSource_LSI|RCCSYSCLKReg);   
...
static void SetSysClockToEXTCLK(void)
{
	...
	if (EXTCLKStatus == (uint32_t)0x01)
	{
        ...
        RCCSYSCLKReg = RCC->CFGR;
		RCCSYSCLKReg &= (uint32_t)((uint32_t)~(RCC_CFGR_SW_Mask));
		RCC->CFGR |= (uint32_t)(RCC_SYSCLKSource_EXTCLK|RCCSYSCLKReg); 
