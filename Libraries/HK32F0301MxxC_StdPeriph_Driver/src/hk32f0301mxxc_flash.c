/********************************************************************************
  ...
  * @author:    AE Team
  * @version:   V1.0.1/2024-05-24
  *             1.Set the code program/earse value
  * @log:       V1.0.0/2022-09-14
  *             1.Initial version
  *******************************************************************************/
...
/**
  * @brief  Sets the code program/earse value.
  * @retval None
  */
static void FLASH_PrgEarseCfg(void)
{
    uint32_t WrData;
    WrData = *(uint32_t *)ADDR_MTP_CONFIG;
    WrData &= (~MASK_TRIM);
    WrData |= VAL_TRIM_01;
    *(uint32_t *)ADDR_MTP_CONFIG = WrData;
}

/**
  * @brief  Sets the code read value.
  * @retval None
  */
static void FLASH_ReadCfg(void)
{
    uint32_t WrData;
    WrData = *(uint32_t *)ADDR_MTP_CONFIG;
    WrData &= (~MASK_TRIM);
...
FLASH_Status FLASH_ErasePage(uint32_t Page_Address)
{
    ...
    /* Sets the code program/earse value */
    FLASH_PrgEarseCfg();
