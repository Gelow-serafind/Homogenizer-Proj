...
* @filename:  hk32f0301mxxc_flash.h
...
* @{
*/
#define ADDR_MTP_CONFIG     ((uint32_t)0x4002207c)
#define MASK_VRDCG_SEL     ((uint32_t)(0x3 << 2))

#define MASK_TRIM           ((unsigned int)(0x3 << 4))
#define VAL_TRIM_01         ((unsigned int)(0x1 << 4))
#define VAL_TRIM_02         ((unsigned int)(0x2 << 4))
